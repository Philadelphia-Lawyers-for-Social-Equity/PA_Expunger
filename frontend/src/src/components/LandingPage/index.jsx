...
export default function LandingPage() {
    ...
    return (
        ...
        <Card>
                <Card.Header className="text-start h3 py-3">
                    Attorneys
                </Card.Header>

                <Card.Body className="text-center">
                    <p>Please select the attorney that you will be filing for:</p>
                    <Form.Select
                        id="attorneyNames"
                        value={attorneyKey}
                    ...
                    {(!attorneyData || attorneyData.length === 0) && !isError && isAuthenticated &&
                        <p className="mt-2 text-muted">Loading attorneys or no attorneys available...</p>
                    }
                </Card.Body>

            <Card.Footer>
                {isError && (
                    <div className="text-danger text-center w-100 mb-2">
                        {errorMessage}
                    </div>
                )}
