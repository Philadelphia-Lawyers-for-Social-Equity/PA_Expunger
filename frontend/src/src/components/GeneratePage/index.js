...
export default function GeneratePage(props) {
    ...
    */
	...
	const [dockets, setDockets] = useState(
		petitionFields.petitions[petitionNumber].docket_numbers
	);
	const [charges, setCharges] = useState(
		petitionFields.petitions[petitionNumber].charges
	);
	const [fines, setFines] = useReducer(
		mergeReduce,
		petitionFields.petitions[petitionNumber].fines
	);
	...
	return (
		<Form className='generator'>
			...
			<Petition
				{...petition}
				handleChange={setPetition}
				disabled={formDisabled}
			/>
			<Dockets
				dockets={dockets}
				handleChange={setDockets}
				disabled={formDisabled}
			/>
			<Charges
				charges={charges}
					...
					<Form.Group as={Row}>
						<Col>
							<Alert variant='success'>
								Your petition has been generated. Please ensure that it is
								correct!
							</Alert>
						</Col>
					</Form.Group>
