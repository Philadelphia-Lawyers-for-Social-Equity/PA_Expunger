        ...
        <Container fluid className="pt-4">
            ...
            <Card className="mb-4 ">
                ...
                <ListGroup variant="flush">
                    <ListGroup.Item className="p-0 ps-3 pt-2">{"Name: " + petitioner.name}</ListGroup.Item>
                    <ListGroup.Item className="p-0 ps-3 pt-2 pb-2">{"Date of Birth: " + petitioner.dob}</ListGroup.Item>
                </ListGroup>
            </Card>
            {petitionSummaries}
