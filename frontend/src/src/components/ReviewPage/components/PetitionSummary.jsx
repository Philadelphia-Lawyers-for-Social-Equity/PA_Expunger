...
export default function PetitionSummary(props) {
    ...
    const chargeRows = charges.map((charge, index) => {
        return (
            <tr key={index}>
                <td className="p-0 ps-2 pe-2">{charge.statute}</td>
                <td className="p-0 ps-2 pe-2">{charge.description}</td>
                <td className="p-0 ps-2 pe-2">{charge.grade}</td>
                <td className="p-0 ps-2 pe-2">{charge.disposition}</td>
                <td className="p-0 ps-2 pe-2">{charge.date}</td>
            </tr>
        )
    })
            ...
            <Card.Body>
                <Row >
                    <Table size="sm" className="w-100">
                        <thead>
                            <tr>
                                <th className="p-0 ps-2 pe-2" style={{ width: "30%" }}>Docket Numbers</th>
                                <th className="p-0 ps-2 pe-2" style={{ width: "20%" }}>OTN</th>
                                <th className="p-0 ps-2 pe-2" style={{ width: "30%" }}>Fines</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                ...
                <Row>
                    <Table>
                        <thead>
                            <tr>
                                <th className="p-0 ps-2 pe-2">Statute</th>
                                <th className="p-0 ps-2 pe-2">Description</th>
                                <th className="p-0 ps-2 pe-2">Grade</th>
                                <th className="p-0 ps-2 pe-2">Disposition</th>
                                <th className="p-0 ps-2 pe-2">Date</th>
                            </tr>
                        </thead>
                        <tbody>
                            {chargeRows}
